...
return function(self, statement, funcDepth)
    ...
    if statement.elsebody then
        ...
        -- v14.7 fix: use activeBlock.scope, not stale scope from true-branch/elseif
        local elseScope = self.activeBlock.scope;
        self:addStatement(self:setRegister(elseScope, self.POS_REGISTER, Ast.NumberExpression(finalBlock.id)), {self.POS_REGISTER}, {}, false);
    end
